...
func NewNode(data string, nType NodeType) Node {
	switch nType {
	case JSType:
	...
	case ComponentType:
		return &ComponentNode{BaseNode: BaseNode{data: data, visible: false}}
	case TextType:
		return &TextNode{BaseNode: BaseNode{data: data, visible: true}}
	default:
